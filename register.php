      ...
      <div class="col-md-6 m-auto pt-5">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <h3>Welcome to Akshayakalpa</h3>
            <label for="exampleInputPassword1">First Name</label>
            <input type="text" class="form-control" name="name" placeholder="enter name">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Email</label>
            <input type="email" class="form-control" name="email" placeholder="enter last name">
          </div>
          <div class="form-group">
            <label for="cars">Select City:</label>
            <select id="cars" name="city" style="padding: 10px;">
